...
for (i in 1:nrow(gtf)){
  ...
  gtf$frame[i] <- '.'
  gtf$attribute[i] <- sprintf('gene_id "%s" ; event_type "%s"', sub(";", "_", event_id), separated_values[2]) #gene_id = event_id and ";" is transformed to "_" and Skipped Exon or Retained Intron 
