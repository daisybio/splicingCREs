...
columns = ['Event', 'Event type', 'Total Amount of IHEC Entries', 
           ...
           'Upstream', 'Overlapping', 'Downstream', 'Significant Segments Spearman',
           'Class'] 
            ...
            if eventID not in skip_eventID:
                ...
                with open(segmentation_filepath, 'r') as seg_file: #, open(output_filepath,'w') as output_file:
                    ...
                    for seg in significant_segments_spearman:
                        ...
                        elif(start_seg<=a4 and end_seg>=a1):
...
df_HM_Overlap_SegSpearman.to_csv('/nfs/home/students/a.schuhe/scripts/splicingREMs/output_CorrelationShuffle/df_HM_Overlap_Up_Down_Ov_SegSpearman.csv', index=False)
